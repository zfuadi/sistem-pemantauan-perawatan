<html>
	...
	<nav>
		<ul>
			<li><a href="page-index-peminjam.php">Home</a></li>
			<li><a href="page-data-barang.php">List Barang</a></li>
			<li><a href="page-histori-peminjaman.php">Histori<br>Peminjaman</a></li>
			<li><a href="page-kritik-saran.php">Kritik dan Saran</a></li>
		</ul>
	</nav>
	<?php }?>
</html>
